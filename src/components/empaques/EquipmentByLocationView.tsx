        ...
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Consulte el inventario de Cabezales, Caseteras y Frenos asignados a cada establecimiento
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => selectedEmpaqueId && loadLocationEquipment(selectedEmpaqueId)}
        ...
        {selectedEmpaque && (
          <div className="mt-4 pt-4 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
            <div>
              ...
              <span className="font-semibold text-slate-800">{selectedEmpaque.ubicacion}</span>
            </div>
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-bold block">Distancia</span>
              <span className="font-semibold text-slate-800">{selectedEmpaque.distancia} km de base</span>
            </div>
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-bold block">Bancos Sinclair</span>
              <span className="font-semibold text-slate-800">
                {selectedEmpaque.bancos.length} bancos ({selectedEmpaque.bancos.reduce((a, b) => a + b.lineas, 0)} líneas)
              </span>
            </div>
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-bold block">Total Equipos Activos</span>
              <span className="font-bold text-blue-700">{equipmentData?.total || 0} unidades</span>
            </div>
          </div>
        )}
      </div>
          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400">Printheads ({equipmentData?.cabezales.length || 0})</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400">Cassettes ({equipmentData?.caseteras.length || 0})</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            {(!equipmentData || equipmentData.caseteras.length === 0) ? (
              ...
              equipmentData.caseteras.map((cas) => (
                <div key={cas.id} className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-1.5">
                  <div className="flex items-center justify-between font-bold">
          ...
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400">Brakes ({equipmentData?.frenos.length || 0})</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            {(!equipmentData || equipmentData.frenos.length === 0) ? (
              ...
              equipmentData.frenos.map((frn) => (
                <div key={frn.id} className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-1.5">
                  <div className="flex items-center justify-between font-bold">
